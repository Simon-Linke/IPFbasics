...
def IPF(g,p,g0):
    ...
    # g is an array with the previous n system states
    # p is an array of IPF modeling parameters \alpha and \beta_k
    # g0 is an initial value used when IPF is diverging
    g1=np.array(g)
...
def IPF_ser(it,p,g0):
    ...
    # it number of iterations of calculating the IPF
    # p is array of IPF modelling paramters \alpha and \beta_k
    # g0 is the initial value, which is used when IPF is diverging
    g=np.ones(len(p))*g0
